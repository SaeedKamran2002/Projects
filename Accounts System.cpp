...
class Manager : public Chemical_Company
{
	...
	{		
		...
		void ledger()
		{
			...
			long int amount = totdebit-totcredit;
			
			if(amount>0)
			{
				cout<<"\nAccount Payable = "<<(totdebit-totcredit);
			}
			
			else if(amount<0)
			{
				cout<<"\nAccount Recievable = "<<(totdebit-totcredit);
			}
			
			else
			{
				cout<<"\nBalanced = "<<(totdebit-totcredit);
			}
	...
	void expensesAccount()
	{
		...
		cout<<"\t\t\t\t\t\t    ----------------\n";
			...
			long int z = totPro-totexp ;
			
			if(z >= 0)
			{
				cout<<"\n\n\nTotal Expenses Amount = "<<totexp;
				cout<<"\nTotal Revenue = "<<totPro;
				cout<<"\nNet Income = "<<totPro-totexp;
	...
	void searchDebit()
	{
		...
		cin>>task;
			...
			if(task==1)
			{
				...
				cout<<"\t\t\t\t\t\t     ---------------\n";
				cout<<"\t\t\t\t\t\t      A/C Recievables  Details\t\t\n";
				cout<<"\t\t\t\t\t\t     ---------------\n";
			
				cout<<"\n\t\t\tS.No\tDate\t\tName\t\tBank Name\tCash Type\tA/C Recievables"<<endl;
				cout<<"========================================================================================================================"<<endl;
	...
	void searchCredit()
	{
		...
		cin>>task;
			...
			if(task==1)
			{
				...
				cout<<"\t\t\t\t\t\t     ---------------\n";
				cout<<"\t\t\t\t\t\t      A/C Payable Details\t\t\n";
				cout<<"\t\t\t\t\t\t     ---------------\n";
			
				cout<<"\n\t\t\tS.No\tDate\t\tName\t\tBank Name\tCash Type\tA/C Payable"<<endl;
				cout<<"========================================================================================================================"<<endl;
		...
		void cashbook()
		{
			...
			cout <<"\t"<< "S:no\t"<<"Recived Date\t"<<"A/C Recievables\t"<<"Recived Amount"<<"\t"<<"Paid Date\t"<<"A/C Payable\t"<<"Paid Amount"<<endl;
			cout<<"========================================================================================================================"<<endl;
			...
			cout<<"\n\n\n\t A/C Recievables ="<<totalDebit<<endl;
			cout<< "\t A/C Payables ="<<totalCredit<<endl;
...
void setChoice()
	{
		...
		cout<<"\t\t 2. Enter Account Recievables\n";
		cout<<"\t\t 3. Enter Account Payables\n";
		cout<<"\t\t 4. Sales And Purchase\n";
		cout<<"\t\t 5. Purchase details\n";
		cout<<"\t\t 6. Selling details\n";
		cout<<"\t\t 7. CashBook\n";
		cout<<"\t\t 8. Account Recievables Details\n";
		cout<<"\t\t 9. Account Payables Details\n";
		cout<<"\t\t 10. Bank Statement\n";
		cout<<"\t\t 11. Chemical List\n";
		cout<<"\t\t 12. Ledger\n";
		cout<<"\t\t 13. Enter Expenses\n";
		cout<<"\t\t 14. Income Statement\n";
